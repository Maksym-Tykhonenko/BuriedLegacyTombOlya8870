...
import ClueTrialScreen from '../screens/ClueTrialScreen';
import TrialReportScreen from '../screens/TrialReportScreen';
import LoadingScreen from '../screens/LoadingScreen';
import MainTabsScreen from '../screens/MainTabsScreen';
import FieldNoteEditorScreen from '../screens/FieldNoteEditorScreen';
import OnboardingScreen from '../screens/OnboardingScreen';
import CipherChamberScreen from '../screens/CipherChamberScreen';
import SecretSiteScreen from '../screens/SecretSiteScreen';
import RelicAssemblyGameScreen from '../screens/RelicAssemblyGameScreen';
import RelicAssemblyResultScreen from '../screens/RelicAssemblyResultScreen';
  ...
  const Route = ({isFatch}) => {
    ...
    return (
      <Stack.Navigator
        ...
        <Stack.Screen name="SecretSite" component={SecretSiteScreen} />
        <Stack.Screen name="DossierDetail" component={DossierDetailScreen} />
        <Stack.Screen name="FieldNoteEditor" component={FieldNoteEditorScreen} />
        <Stack.Screen name="ClueTrial" component={ClueTrialScreen} />
        <Stack.Screen name="TrialReport" component={TrialReportScreen} />
        <Stack.Screen name="CipherChamber" component={CipherChamberScreen} />
        <Stack.Screen name="RelicAssemblyGame" component={RelicAssemblyGameScreen} />
        <Stack.Screen name="RelicAssemblyResult" component={RelicAssemblyResultScreen} />
      </Stack.Navigator>
    );
  };
...
// <Stack.Screen name="Loading" component={LoadingScreen} />
  return (
    <NavigationContainer theme={navTheme}>
      {!isLoading ? <LoadingScreen /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
}
